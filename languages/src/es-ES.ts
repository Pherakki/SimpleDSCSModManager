...
<context>
    ...
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="17"/>
        <source>{hyperlink_open}issue tracker{hyperlink_close}</source>
        <translation>{hyperlink_open}gestor de fallos{hyperlink_close}</translation>
    </message>
</context>
<context>
    <name>Application::AlphaNotice</name>
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="22"/>
        <source>Alpha Build Notice</source>
        <translation>Aviso de versión alfa</translation>
    </message>
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="23"/>
        <source>This is an alpha build of SimpleDSCSModManager which has several incomplete features. You may run into bugs using some features of this program. If you encounter one, please check whether this bug is already an open issue at the {issue_tracker}, and if not, open a new issue.</source>
        <translation>Esta es una versión alfa de SimpleDSCSModManager, que contiene varias características incompletas. Es posible que encuentres fallos al utilizar algunas características de este programa. En caso de encontrar una, comprueba si el fallo ya ha sido mencionado en el {issue_tracker} y si no ha sido mencionado, abre un informe nuevo.</translation>
    </message>
</context>
<context>
    <name>Application::FatalErrorPopup</name>
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="110"/>
        <source>Fatal Error</source>
        <translation>Error fatal</translation>
    </message>
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="110"/>
        <source>SimpleDSCSModManager has encounted an issue and needs to close. The error is:&lt;br&gt;&lt;br&gt;{error_message}&lt;br&gt;&lt;br&gt;Please check whether this bug is already an open issue at the {issue_tracker}, and if not, open a new issue. Please include your crashlog.txt (found in the logs folder of SimpleDSCSModManager), and the &lt;b&gt;&lt;i&gt;precise&lt;/i&gt;&lt;/b&gt; step-by-step instructions required to reproduce the issue, alongside as much information as you can provide that may be relevant, including installed mods, and anything you have tried that &lt;i&gt;e.g.&lt;/i&gt; prevents the bug or changes what happens. The more detail you can include, the easier it is to fix.</source>
        <translation>SimpleDSCSModManager ha encontrado un problema y debe cerrar la aplicación. El error es:&lt;br&gt;&lt;br&gt;{error_message}&lt;br&gt;&lt;br&gt;Comprueba si el fallo ya ha sido mencionado en el {issue_tracker} y si no ha sido mencionado, abre un informe nuevo. Por favor, al abrir un informe nuevo, incluye el archivo crashlog.txt (lo encontrarás en la carpeta «logs» de SimpleDSCSModManager) y unas instrucciones &lt;b&gt;&lt;i&gt;precisas&lt;/i&gt;&lt;/b&gt;, paso a paso, además de toda la información que puedas ofrecer y que sea de importancia, como mods instalados y todo lo que hayas probado que, &lt;i&gt;por ejemplo&lt;/i&gt;, evite el fallo o cambie la reacción. Cuantos más detalles incluyas, más fácil será arreglarlo.</translation>
    </message>
</context>
<context>
    <name>Application::GamePathDetectedPopup</name>
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="157"/>
        <source>Game path detected</source>
        <translation>Ruta del juego detectada</translation>
    </message>
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="157"/>
        <source>Your game installation has been automatically detected at:

{filepath}.</source>
        <translation>Se ha detectado automáticamente la carpeta de instalación de tu juego en:

{filepath}.</translation>
    </message>
</context>
<context>
    <name>Application::UACPermissionsWarning</name>
    <message>
...
<context>
    <name>ArchiveTypes::AFS2</name>
    <message>
        <location filename="../../plugins/archives/AFS2.py" line="33"/>
        <source>Packing AFS2 {archive_name}... unpacking base archive to build directory...</source>
        <translation>Empaquetando AFS2 {archive_name}... Desempaquetando archivo base a la carpeta de compilación...</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/AFS2.py" line="70"/>
        <source>Packing AFS2 {archive_name}...</source>
        <translation>Empaquetando AFS2 {archive_name}...</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/AFS2.py" line="53"/>
        <source>Packing AFS2 {archive_name}... copying mod files to build directory...</source>
        <translation>Empaquetando AFS2 {archive_name}... Copiando archivos modificados a la carpeta de compilación...</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/AFS2.py" line="68"/>
        <source>Backing up AFS2 {archive_name}...</source>
        <translation>Haciendo copia de seguridad del AFS2 {archive_name}...</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/AFS2.py" line="73"/>
        <source>Something critically bad happened to the archive packing directory - aborting.</source>
        <translation>Un error crítico ha ocurrido en la carpeta de empaquetado del archivo, abortando.</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/AFS2.py" line="75"/>
        <source>Packing AFS2 {archive_name}... Done.</source>
        <translation>Empaquetando AFS2 {archive_name}... Listo.</translation>
    </message>
</context>
<context>
    <name>ArchiveTypes::LooseFiles</name>
    <message>
        <location filename="../../CoreOperations/PluginLoaders/ArchivesPluginLoader.py" line="81"/>
        <source>Copying loose files...</source>
        <translation>Copiando archivos sueltos...</translation>
    </message>
</context>
<context>
    <name>ArchiveTypes::MDB1</name>
    <message>
        <location filename="../../plugins/archives/MDB1.py" line="60"/>
        <source>Packing MDB1 {archive_name}... unpacking base archive to build directory...</source>
        <translation>Empaquetando MDB1 {archive_name}... Desempaquetando archivo base a la carpeta de compilación...</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/MDB1.py" line="102"/>
        <source>Packing MDB1 {archive_name}...</source>
        <translation>Empaquetando MDB1 {archive_name}...</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/MDB1.py" line="85"/>
        <source>Packing MDB1 {archive_name}... copying mod files to build directory...</source>
        <translation>Empaquetando MDB1 {archive_name}... Copiando archivos modificados a la carpeta de compilación...</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/MDB1.py" line="100"/>
        <source>Backing up MDB1 {archive_name}...</source>
        <translation>Haciendo copia de seguridad del MDB1 {archive_name}...</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/MDB1.py" line="105"/>
        <source>Something critically bad happened to the archive packing directory - aborting.</source>
        <translation>Un error crítico ha ocurrido en la carpeta de empaquetado del archivo, abortando.</translation>
    </message>
    <message>
        <location filename="../../plugins/archives/MDB1.py" line="107"/>
        <source>Packing MDB1 {archive_name}... Done.</source>
        <translation>Empaquetando MDB1 {archive_name}... Listo.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <source>Categorising install graph pipelines... Done. [{counted_total}/{real_total}]</source>
    ...
    <message>
        ...
        <source>Creating missing mod indices... [{i}/{n_missing_mods}] [{mod_name}]</source>
        <translation type="obsolete">Creando índices de mods que faltan... [{i}/{n_missing_mods}] [{mod_name}]</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/ModBuildGraph/__init__.py" line="115"/>
        <source>Creating missing mod indices... Done. [{i}/{n_missing_mods}]</source>
        <translation type="obsolete">Creando índices de mods que faltan... Listo. [{i}/{n_missing_mods}]</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/ModBuildGraph/__init__.py" line="137"/>
        <source>Building install graph nodes... [{i}/{n}] [{mod_name}]</source>
...
<context>
    <name>Common</name>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MDB1Multithreaded.py" line="51"/>
        <source>[Step {curStep}/{maxSteps}] </source>
    ...
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="38"/>
        <source>OK</source>
        <translation>Aceptar</translation>
    </message>
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="39"/>
        <source>Yes</source>
        <translation>Sí</translation>
    </message>
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="40"/>
        <source>No</source>
        <translation>No</translation>
    </message>
    <message>
        <location filename="../../SimpleDSCSModManager.py" line="41"/>
...
<context>
    ...
    <message>
        ...
        <source>SimpleDSCSModManager initialised.</source>
        <translation>SimpleDSCSModManager iniciado.</translation>
    </message>
    <message>
        <location filename="../../MainWindow.py" line="41"/>
        <source>If you&apos;re encountering issues installing mods, remember to use SimpleDSCSModManager in a non-protected location (e.g. not Desktop, Documents, etc.) and run it in Admin mode.</source>
        <translation>Si tienes problemas para instalar mods, recuerda que debes copiar SimpleDSCSModManager en una carpeta no protegida (por ejemplo: que no sea el escritorio, Mis Documentos, etc.) y que debes ejecutarlo como administrador.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>SimpleDSCSModManager</source>
        <translation>SimpleDSCSModManager</translation>
    </message>
    <message>
        <location filename="../../MainWindow.py" line="66"/>
        <source>Language changed to English (US).</source>
        <translation>Se ha cambiado el idioma a Español (España).</translation>
    </message>
    <message>
        <location filename="../../MainWindow.py" line="39"/>
        <source>Enjoying Cyber Sleuth modding? Consider supporting more projects like this on {hyperlink_open}Patreon{hyperlink_close}!</source>
        <translation>¿Te gusta trastear con Cyber Sleuth? Puedes apoyar más proyectos como este en {hyperlink_open}Patreon{hyperlink_close}!</translation>
    </message>
    <message>
        <location filename="../../MainWindow.py" line="40"/>
        <source>Want to contribute to modding tools or develop mods? Consider joining the {hyperlink_open}Digimon Modding Community discord server{hyperlink_close}.</source>
        <translation>¿Quieres poner tu granito de arena a las herramientas de modificación o desarrollar mods? Puedes unirte al {hyperlink_open}servidor de Discord de la Digimon Modding Community{hyperlink_close}.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="../../CoreOperations/ModInstallation/PipelineRunners.py" line="83"/>
        <source>{current_step_message}{main_message}... </source>
        <translation>{current_step_message}{main_message}... </translation>
    </message>
    <message>
        <location filename="../../CoreOperations/ModInstallation/PipelineRunners.py" line="89"/>
        <source>{current_step_message}{main_message}... Done. </source>
        <translation>{current_step_message}{main_message}... Listo. </translation>
    </message>
    <message>
        <location filename="../../CoreOperations/ModInstallation/PipelineRunners.py" line="133"/>
        <source>[Step {curStep}/{maxSteps}] </source>
        <translation>[Paso {curStep}/{maxSteps}] </translation>
    </message>
    <message>
        <location filename="../../CoreOperations/ModInstallation/PipelineRunners.py" line="138"/>
        <source>{current_step_message}Building {archive_name} files...</source>
...
<context>
    <name>ModInstall::Debug</name>
    <message>
        <location filename="../../CoreOperations/ModInstallation/PipelineRunners.py" line="101"/>
        <source>---pipeline build log message---</source>
        <translation>---mensaje de registro de la compilación de procesos---</translation>
    </message>
</context>
<context>
    <name>ModMetadataParsing</name>
    <message>
...
<context>
    <name>ModRegistry</name>
    <message>
        <location filename="../../CoreOperations/ModRegistry/__init__.py" line="24"/>
        <source>Mod version is not an integer.</source>
        <translation>La versión del mod no es un número entero.</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/ModRegistry/__init__.py" line="26"/>
        <source>Unrecognised mod version &apos;{version}&apos;.</source>
...
<context>
    <name>ModWizards::CYMIS</name>
    <message>
        <location filename="../../CoreOperations/PluginLoaders/ModInstallersPluginLoader.py" line="39"/>
        <source>Registry wizard encountered an error: {error}.</source>
        <translation>El asistente de registro ha tenido un error: {error}.</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/PluginLoaders/ModInstallersPluginLoader.py" line="51"/>
        <source>Error parsing CYMIS INSTALL.JSON script: {msg}</source>
        <translation>Error al analizar el script CYMIS INSTALL.JSON: {msg}</translation>
    </message>
    <message>
...
<context>
    <name>ModWizards::CYMIS::FallbackUI</name>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="165"/>
        <source>No Title</source>
        <translation>Sin título</translation>
    </message>
</context>
<context>
    <name>ModWizards::CYMIS::Logging</name>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="79"/>
        <source>More than one boolean operator in dictionary: {dict_printout}.</source>
        <translation>Hay más de un operador booleano en el diccionario: {dict_printout}.</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="106"/>
        <source>{filepath} is neither a file nor a directory.</source>
        <translation>{filepath} no es un archivo o un directorio.</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="115"/>
        <source>Paths may not contain relative references.</source>
        <translation>Las rutas no pueden contener referencias relativas.</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="156"/>
        <source>Checking flag table before install...</source>
        <translation>Comprobando tabla de indicadores antes de instalar...</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="158"/>
        <source>{flag_name} is {_bool}.</source>
        <translation>{flag_name} es {_bool}.</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="173"/>
        <source>Found flag: {flag_type} {flag_name}</source>
        <translation>Indicador encontrado: {flag_type} {flag_name}</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="188"/>
        <source>Auto-pass: No &apos;if&apos; statement.</source>
        <translation>Validación automática: No puede haber instrucciones  «If».</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="195"/>
        <source>Will execute; {execution_condition} is {_bool}.</source>
        <translation>Se ejecutará; {execution_condition} es {_bool}.</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="197"/>
        <source>Will not execute; {execution_condition} is {_bool}.</source>
        <translation>No se ejecutará; {execution_condition} es {_bool}.</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="206"/>
        <source>Will execute; compound statement is {_bool}.</source>
        <translation>Se ejecutará; la instrucción compuesta es {_bool}.</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Cymis/CymisParser.py" line="209"/>
        <source>Unrecognised installation condition type: {data_type}. Should be a string, dict, or not present.</source>
        <translation>Tipo de condición de instalación no reconocido: {data_type}. Debería ser una cadena, diccionario, o no existir.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="../../CoreOperations/ProfileManager.py" line="27"/>
        <source>Failed to load mod categories from {filepath}</source>
        <translation>Error al cargar las categorías de mods de {filepath}</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/ProfileManager.py" line="50"/>
        <source>New Profile</source>
        <translation>Perfil nuevo</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/ProfileManager.py" line="53"/>
        <source>New Profile {number}</source>
        <translation>Perfil nuevo {number}</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/ProfileManager.py" line="62"/>
...
<context>
    <name>Tools::MBE</name>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MBEMultithreaded.py" line="42"/>
        <source>{pack_or_extract_verb} MBEs from {filepath}... </source>
        <translation>{pack_or_extract_verb} MBE de {filepath}... </translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MBEMultithreaded.py" line="48"/>
        <source>{pack_or_extract_verb} MBEs from {filepath}... Done. </source>
        <translation>{pack_or_extract_verb} MBE de {filepath}... Listo. </translation>
    </message>
</context>
<context>
    <name>Tools::MBE::Debug</name>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MBEMultithreaded.py" line="67"/>
        <source>---MDB1 extractor message---</source>
        <translation>---mensaje del extractor de MDB1---</translation>
    </message>
</context>
<context>
    <name>Tools::MBE::ExtractVerb</name>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MBEMultithreaded.py" line="84"/>
        <source>Extracting</source>
        <translation>Extrayendo</translation>
    </message>
</context>
<context>
    <name>Tools::MBE::PackVerb</name>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MBEMultithreaded.py" line="91"/>
        <source>Packing</source>
        <translation>Empaquetando</translation>
    </message>
</context>
<context>
    <name>Tools::MDB1</name>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MDB1Multithreaded.py" line="22"/>
        <source>No files were passed for extraction!</source>
        <translation>¡No se han asignado archivos a extraer!</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MDB1Multithreaded.py" line="59"/>
        <source>{step_count_msg}Extracting {filename}... </source>
        <translation>{step_count_msg}Extrayendo {filename}... </translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MDB1Multithreaded.py" line="65"/>
        <source>{step_count_msg}Extracting {filename}... Done. </source>
        <translation>{step_count_msg}Extrayendo {filename}... Listo. </translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MDB1Multithreaded.py" line="144"/>
        <source>Extracting {archive_name} to {filepath}... </source>
        <translation>Extrayendo {archive_name} a {filepath}... </translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MDB1Multithreaded.py" line="150"/>
        <source>Extracting {archive_name} to {filepath}... Done. </source>
        <translation>Extrayendo {archive_name} a {filepath}... Listo. </translation>
    </message>
</context>
<context>
    <name>Tools::MDB1::Debug</name>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MDB1Multithreaded.py" line="79"/>
        <source>---MDB1 filelist extractor message---</source>
        <translation>---mensaje del extractor del listado de archivos del MDB1---</translation>
    </message>
    <message>
        <location filename="../../CoreOperations/Tools/DSCSToolsHandler/MDB1Multithreaded.py" line="163"/>
        <source>---MDB1 extractor message---</source>
        <translation>---mensaje del extractor de MDB1---</translation>
    </message>
</context>
...
<context>
    <name>UI::DeleteProfileButton</name>
    <message>
...
<context>
    <name>UI::GameLaunchMethodBox</name>
    <message>
...
<context>
    <name>UI::GameLocationLabel</name>
    <message>
...
<context>
    <name>UI::InstallModsButton</name>
    <message>
...
<context>
    <name>UI::Localisation</name>
    <message>
        <location filename="../../MainWindow.py" line="95"/>
        <source>Language names file &quot;{filepath}&quot; was not found. Using default language names.</source>
        <translation>No se ha encontrado el archivo de nombres de idiomas «{filepath}». Utilizando los nombres predeterminados.</translation>
    </message>
    <message>
        <location filename="../../MainWindow.py" line="104"/>
        <source>Could not find language name &quot;{lang_name}&quot; in the languages names file. Using default name.</source>
        <translation>No se ha podido encontrar el nombre del idioma «{lang_name}» en el archivo de nombres de idiomas. Utilizando el nombre predeterminado.</translation>
    </message>
    <message>
        <location filename="../../MainWindow.py" line="109"/>
        <source>Languages directory &quot;{filepath}&quot; was not found. No translation files loaded.</source>
        <translation>No se ha encontrado el directorio de idiomas «{filepath}». No se ha cargado ningún archivo de traducción.</translation>
    </message>
</context>
<context>
    <name>UI::MenuBar</name>
    <message>
...
<context>
    <name>UI::ModInfo::NoSelection</name>
    <message>
...
<context>
    <name>UI::ModRightClickMenu</name>
    <message>
...
<context>
    <name>UI::PurgeModCacheButton</name>
    <message>
...
<context>
    <name>UI::PurgeModIndicesButton</name>
    <message>
...
<context>
    <name>UI::PurgeResourcesButton</name>
    <message>
...
<context>
    <name>UI::RenameProfileButton</name>
    <message>
...
<context>
    <name>UI::TriedToDeleteFinalProfilePopup</name>
    <message>
...
<context>
    <name>UI::UninstallModsButton</name>
    <message>
...
<context>
    <name>UI::UpdateDSCSToolsButton</name>
    <message>
